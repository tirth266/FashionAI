    ...
    <section id="how-it-works" className="py-24">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <p className="text-gray-400">Your journey to a better style in three simple steps.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 relative">
          ...
          {steps.map((step, i) => (
            ...
            >
              <div className="w-20 h-20 bg-dark border border-gray-800 rounded-full flex items-center justify-center mx-auto mb-6 shadow-xl">
