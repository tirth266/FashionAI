...
export const AuthLayout = ({ children, title, subtitle }) => {
  return (
    <div className="min-h-screen flex bg-black text-gray-900 dark:text-white overflow-hidden">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-black">
        ...
        >
          <div className="text-center lg:text-left">
            <h2 className="text-3xl font-bold tracking-tight text-gray-950 dark:text-white">{title}</h2>
